  ...
  return (
    <section id="services" className="py-16 md:py-28 px-4 md:px-6 max-w-7xl mx-auto">
      <div className="text-center mb-12 md:mb-16">
        <motion.p initial={{ y: 20 }} whileInView={{ y: 0 }} viewport={{ once: true, amount: 0 }} transition={{ duration: 0.5 }} className="text-[#ae805c] text-xs tracking-[0.3em] uppercase mb-3">{t.services.subtitle}</motion.p>
        <motion.h2 initial={{ y: 24 }} whileInView={{ y: 0 }} viewport={{ once: true, amount: 0 }} transition={{ duration: 0.55, delay: 0.05 }} className="text-3xl md:text-5xl font-light text-[#dfd3c3] mb-6">{t.services.title}</motion.h2>
