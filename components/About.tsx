  ...
  return (
    <section id="about" className="py-16 md:py-24 px-4 md:px-6 max-w-7xl mx-auto">
      <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        <div>
          <p className="text-[#ae805c] text-xs tracking-[0.3em] uppercase mb-4">{t.about.subtitle}</p>
          <h2 className="text-3xl md:text-5xl font-light text-[#dfd3c3] mb-5">{t.about.title}</h2>
          <div className="divider mb-8" />
          <p className="text-[#dfd3c3]/70 leading-relaxed mb-5 text-base md:text-lg">{t.about.text1}</p>
          <p className="text-[#dfd3c3]/70 leading-relaxed mb-8 text-base md:text-lg">{t.about.text2}</p>
          <a
